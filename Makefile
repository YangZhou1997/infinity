...
examples:
	...
	$(CC) src/examples/multi-qp.cpp $(CC_FLAGS) $(LD_FLAGS) -I $(RELEASE_FOLDER)/$(INCLUDE_FOLDER) -L $(RELEASE_FOLDER) -lpthread -o $(RELEASE_FOLDER)/$(EXAMPLES_FOLDER)/multi-qp
